function fatBastard(meal) { // whatsForDinner() is the inner function, a closure
  function whatsForDinner() { //whatsForDinner() uses argument provided to the parent function 
    if (!meal) {
